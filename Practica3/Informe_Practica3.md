...
![Pantalla de inicio de sesión](../Documentation/Practica3/img/01-login.png)

**Resumen del panel**

![Resumen del panel administrativo](../Documentation/Practica3/img/02-panel-resumen.png)

**Gestión de semestres**

![Listado de semestres](../Documentation/Practica3/img/03-semestres.png)

![Formulario de alta de semestre](../Documentation/Practica3/img/04-semestres-alta.png)

**Gestión de escuelas**

![Listado de escuelas](../Documentation/Practica3/img/05-escuelas.png)

**Gestión de cursos**

![Listado de cursos con filtros](../Documentation/Practica3/img/06-cursos.png)

![Asignación de docentes a un curso](../Documentation/Practica3/img/07-cursos-docentes.png)

**Gestión de usuarios y docentes**

![Listado de usuarios con sus roles](../Documentation/Practica3/img/08-usuarios.png)

![Listado de docentes](../Documentation/Practica3/img/09-docentes.png)

**Validación de integridad** — el mensaje procede del `RAISE EXCEPTION` del procedimiento almacenado:

![Rechazo al eliminar una entidad con dependientes](../Documentation/Practica3/img/10-error-dependientes.png)
...
![Estudiante redirigido al intentar entrar al panel](../Documentation/Practica3/img/11-rbac-estudiante.png)

### 11.3 Carga masiva de CSV

**Formato documentado en la propia interfaz**

![Documentación del formato CSV](../Documentation/Practica3/img/12-csv-formato.png)

**Selección del archivo**

![Zona de carga con el archivo seleccionado](../Documentation/Practica3/img/13-csv-seleccion.png)

**Resultado de una carga limpia** — 12 filas, 12 insertadas:

![Resumen de la carga correcta](../Documentation/Practica3/img/14-csv-resultado.png)
...
![Resumen de la carga con errores por fila](../Documentation/Practica3/img/15-csv-errores.png)
...
![Resultado de reprocesar el mismo archivo](../Documentation/Practica3/img/16-csv-idempotencia.png)

**Historial de cargas**

![Historial de lotes procesados](../Documentation/Practica3/img/17-csv-historial.png)

### 11.4 Registros insertados mediante procedimientos almacenados

Comprobación directa en la base de datos:

![Grabaciones insertadas por el CSV](../Documentation/Practica3/img/18-db-grabaciones.png)

![Lotes registrados en csv_import_batches](../Documentation/Practica3/img/19-db-lotes.png)

![Errores registrados en csv_import_errors](../Documentation/Practica3/img/20-db-errores.png)
...
![Entidades creadas en cascada por el CSV](../Documentation/Practica3/img/21-db-cascada.png)
...
![Catálogo, primera página](../Documentation/Practica3/img/22-paginacion-p1.png)

![Catálogo, segunda página](../Documentation/Practica3/img/23-paginacion-p2.png)

![Catálogo, última página incompleta](../Documentation/Practica3/img/24-paginacion-p3.png)

**Filtros combinados manteniendo la paginación**

![Catálogo con filtros combinados aplicados](../Documentation/Practica3/img/25-paginacion-filtros.png)

### 11.6 Reproducción

![Reproductor con la grabación en curso](../Documentation/Practica3/img/26-reproductor.png)

### 11.7 Despliegue

![Contenedores en ejecución](../Documentation/Practica3/img/27-compose-ps.png)
